...
class detJadwalController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('tb_detjadwal.id_detjadwal','tb_detjadwal.tanggal_awal','tb_detjadwal.tanggal_akhir','tb_detjadwal.waktu','tb_detjadwal.tempat','tb_jadwal.kegiatan')->orderby('id_detjadwal')
        ->get();
