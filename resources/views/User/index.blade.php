					...
					<div class="row h-100 align-items-center">
						...
						<div class="col-12">
							<div class="welcome-text text-center">
								<h6 data-animation="fadeInLeft" data-delay="200ms">Pemberdayaan Umat Berkelanjutan</h6>
								<h2 data-animation="fadeInLeft" data-delay="500ms">Selamat Datang di Website PUB</h2>
