...
<div id="design" >
	<div class="content">
		<center><h2>STRUKTUR KEPANITIAAN PPMB</h2></center>
					...
					<ul class="director">
						<li>
							<a href="#">
								...
								<span>Abdul Hafiz Tanjung.,S.E.,M.Si.,Ak.,CA</span>
							</a>
							...
							<ul class="departments cf">                             
								<li>
									...
									<li class="department dep-d">
										...
										<li class="department dep-d">
											...
											<li class="department dep-d">
												...
												<a href="{{url('detail/org/'.$kadiv_logistik->id_mahasiswa)}}">
													@else
													<a href="#">
														@endif
														<span>
													...
													<ul class="sections">
														<li class="section">
															@if($kadiv_humas2!=0)
									<a href="{{url('detail/org/'.$kadiv_humas->id_mahasiswa)}}">
																@else
																<a href="#">
																	@endif
																	<span>
													<div style="background-color: #33cc99;">
															...
															<li class="section">
																@if($kadiv_acara2!=0)
									<a href="{{url('detail/org/'.$kadiv_acara->id_mahasiswa)}}">
																	@else
																	<a href="#">
																		@endif
																		<span>
									...
									<a href="{{url('detail/org/'.$kadiv_kesejahtraan->id_mahasiswa)}}">
																		@else
																		<a href="#">
																			@endif
																			<span>
													<div style="background-color: #33cc99;">
																		Kadiv. Kesejahtraan PPMB
																				</div>
																		@if($kadiv_kesejahtraan2==0)
																		<p>data Kosong</p>
																				@else
									...
									<a href="{{url('detail/org/'.$kadiv_dokumentasi->id_mahasiswa)}}">
																				@else
																				<a href="#">
																					@endif
																					<span>
												<div style="background-color: #33cc99;">
													Kadiv. Dokumentasi PPMB
																			</div>
																		@if($kadiv_dokumentasi2==0)
																		<p>data Kosong</p>
																				@else
