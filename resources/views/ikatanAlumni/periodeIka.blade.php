		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<a href="{{url('periode/createIka')}}"><button type="submit" class="btn btn-primary">Tambah Data </button></a>
						...
						<tbody>
							...
							<tr>
								...
								<td align="center" class="col-sm-3">
									<a href="{{url('periode/editIka/'.$data->id)}}">
									...
									<a href="{{url('periode/deleteIka/'.$data->id)}}">
