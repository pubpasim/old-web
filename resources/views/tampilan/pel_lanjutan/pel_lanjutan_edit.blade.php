...
<script type="text/javascript" src="{{url('ckeditor/ckeditor.js')}}"></script>
	<div class="container">
		...
		<form method="POST" action="{{url('pel_lanjutan/update/'.$data->id)}}" enctype="multipart/form-data">
			{{csrf_field()}}
				<div class="col-75">
				...
				<div class="col-75">
					...
					<input readonly="" type="text" class="form-control" name="keterangan" value="{{$data->keterangan}}">
				</div>
				<div class="col-75">
