			...
			<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
				...
				<tbody>
					...
					<tr>
						...
						<td>
						    <center>
						        <a href="{{url('editUser/'.$data->id_user)}}"><button type="reset" class="btn btn-default">Edit</button></a>
						        <a href="{{url('hapusUser/'.$data->id_user)}}" onclick="return confirm('Hapus data ?');"><button class="btn btn-primary" style="background-color: red;">Hapus</button></a>
						    </center>
						</td>
					</tr>
					@endforeach
