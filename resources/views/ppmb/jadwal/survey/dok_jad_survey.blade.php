	...
	<div class="co  l-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="{{url('dok_jad_survey/create/'.$id)}}"><button type="submit" class="btn btn-primary">Tambah Data </button></a>
				<a href="{{url('jad_survey')}}"><button type="submit" class="btn btn-primary">Kembali </button></a>
				...
				<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
					...
					<tbody>
						...
						<tr>
							<td><?php echo $no++; ?></td>
							<td><img src="{{url('imgs/kegiatan_survey')}}/{{$data->foto}}" width="100px"></td>
							<td>{{$data->keterangan}}</td>
							<td>
								<a href="{{url('dok_jad_survey/edit/'.$data->id_dok_survey)}}">
								...
								<a href="{{url('dok_jad_survey/delete/'.$data->id_dok_survey)}}" onclick="return confirm('Apakah anda yakin ?')">
