	...
	<div class="co  l-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="{{url('dok_jad_tpa/create/'.$id)}}"><button type="submit" class="btn btn-primary">Tambah Data </button></a>
				<a href="{{url('jad_tpa')}}"><button type="submit" class="btn btn-primary">Kembali </button></a>
				...
				<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{url('dok_jad_tpa/edit/'.$data->id_jad)}}">
								...
								<a href="{{url('dok_jad_tpa/delete/'.$data->id_jad)}}" onclick="return confirm('Apakah anda yakin ?')">
